...
export const sportsAndFun = {
  ...
  rules: [
    ...
    },
    {
      ...
      detail: '1.05 Makai Lemon. 2.05 Nicholas Singleton. 2.09 Omar Cooper Jr. (Stevenson traded for 2.09 + 2027 2nd). 3.05 take Washington; fallback Stowers then Raridon.',
    },
  ],
};
